...
Set-Mailbox -Identity $upn -ForwardingSMTPAddress nDeTorres@waremalcomb.com

#disables active sync
Set-CASMailbox -Identity $upn -ActiveSyncEnabled $False 

#gives manager full access
Add-MailboxPermission -identity $upn -User nDeTorres@waremalcomb.com -AccessRights FullAccess -InheritanceType all
