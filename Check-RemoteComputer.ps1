...
Try{$username = (Get-WmiObject -Class win32_computersystem -ComputerName $computer).UserName -split "wma-arch.com\\"
}catch
{}
...
#"Slack"
if(Test-Path -Path "C:\Users\$username\AppData\Local\slack\slack.exe"){
$Installed += "Slack"
}else{
$NotInstalled += "Slack"
}
