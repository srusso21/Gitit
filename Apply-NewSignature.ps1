...
#2016 x64
If(Test-Path -Path $path5){Write-host "Office 2016 x64 Installed";$Regpath1 = "HKCU:\Software\Microsoft\Office\16.0\Outlook\Setup";$RegPath2 = "HKCU:\Software\Microsoft\Office\16.0\Common\MailSettings"} 
