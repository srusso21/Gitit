    ...
    $before = (Get-PSDrive | Where-Object {$_.name -eq 'C'} | Select-Object -ExpandProperty free)/1gb
...
$after = (Get-PSDrive | Where-Object {$_.name -eq 'C'} | Select-Object -ExpandProperty free)/1gb
$result = $after-$before
